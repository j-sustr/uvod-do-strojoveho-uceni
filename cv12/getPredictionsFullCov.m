function [ predRef ] = getPredictionsFullCov ( trainData, trainRef, testData )
    
    % % Vektor, kterı bude obsahovat spoèítané pøiøazení testovacích dat ke tøídám
	predRef = zeros(size(testData, 1), 1);
    
    %%% Doplòtì kód pro pravdìpodobností klasifikaci pomocí plné kovarianèní matice (pøíznaky nejsou nezávislé) %%%
